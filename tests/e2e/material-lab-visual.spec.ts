...
test('renders the deterministic Material Lab evidence fixture', async ({ page }) => {
  ...
  await page.goto(
    './?material-lab=1&fixture=foundation&recipe=holographic&environment=spectral-wash&finish=holographic&preview=pill&preset=chromatic&theme=dark&strength=92&paused=1'
  );
