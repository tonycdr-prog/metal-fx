...
export const MATERIAL_RECIPES: readonly MaterialLabRecipe[] = [
  {
    ...
    state: { fixture: 'foundation', preview: 'pill', preset: 'chromatic', theme: 'dark', strength: 100, paused: false }
  },
  {
    id: 'brushed-metal',
    label: 'Brushed metal',
    ...
    state: { fixture: 'foundation', preview: 'content', preset: 'silver', theme: 'light', strength: 76, paused: false }
  },
  {
    id: 'mercury',
    label: 'Mercury',
    ...
    state: { fixture: 'foundation', preview: 'circle', preset: 'silver', theme: 'dark', strength: 94, paused: false }
  },
  {
    id: 'holographic',
    label: 'Holographic',
    ...
    state: { fixture: 'foundation', preview: 'pill', preset: 'chromatic', theme: 'dark', strength: 92, paused: false }
  },
  {
    id: 'copper',
    label: 'Copper',
    ...
    state: { fixture: 'foundation', preview: 'content', preset: 'gold', theme: 'dark', strength: 88, paused: false }
  },
  {
    id: 'obsidian',
    label: 'Obsidian',
    ...
    state: { fixture: 'foundation', preview: 'circle', preset: 'silver', theme: 'dark', strength: 66, paused: false }
  },
  {
    id: 'electric-plasma',
